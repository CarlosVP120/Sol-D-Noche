...
const ProductCard = ({ product }) => {
  return (
    <div className="rounded-lg m-4 shadow-md p-4 hover:shadow-lg transition-all duration-300 transform hover:scale-105 hover:rotate-1">
      <img src={product.image} alt={product.name} className="w-full md:h-96" />
